...
import { HttpDemoClient } from "./legacy/api";
import { emptyProjectState, reduceProjectPatch } from "./legacy/state";
import type { AgentStatus, BrowserEvent, DemoClient, ParameterField, ProjectState, Scalar } from "./legacy/types";
...
export function LegacyApp({ client = defaultClient, sessionId = resolveSessionId() }: { client?: DemoClient; sessionId?: string }) {
