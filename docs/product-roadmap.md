...
> **Current delivery status:** Stages 1 and 2 / #13 are implemented. Stage 2
...
> coexist. Stage 3 / #14 is at the design gate through
> [`milestone-a3-project-execution-design.md`](milestone-a3-project-execution-design.md);
> its Project execution and wind-import contracts are not implementation
> claims. #15 owns the final shared shell.
