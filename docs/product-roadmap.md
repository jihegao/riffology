...
> and no caller-controlled target or browser authority. A3-2c3 interaction is a
> candidate on its review branch and remains pending review and merge; A3-2c4
> live-CDP/complete Chromium security closeout remains pending.
