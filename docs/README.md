...
one-use typed interaction was merged through PR #41. A3-2c4's live-CDP and
real-Chromium security closeout is a candidate on its review branch and remains
pending review and merge; Stage 3 remains in progress.
