...
| **4 — 共享产品 shell** | Models/Projects 首页、最终双栏 UX、动态右栏、Conversation 管理/cards、offline/recovery UX、旧产品清理、完整风机 browser 验收。 | Issue #14 前置已满足；A4-0 设计门禁已建立。A4-1 已提供 schema-v14、Home/集合 DTO、通用 lifecycle/permanent-delete API 与统一 browser admission；A4-2 至 A4-6 仍 pending，本文第 15 节没有任何验收项可标记完成。 |
